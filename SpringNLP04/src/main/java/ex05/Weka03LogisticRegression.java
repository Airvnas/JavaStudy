...
public class Weka03LogisticRegression {
	...
	public void generateModel_Evaluate() throws Exception {
		...
		eval.evaluateModel(model, test);//테스트 진행
	...
	public void testPredict(String file) {
		...
		try {
			...
			for(int i=0;i<newData.numInstances();i++) {
				...
				System.out.println("확률분포-----------");
				System.out.println("prob[0]="+prob[0]);
				System.out.println("prob[1]="+prob[1]);
