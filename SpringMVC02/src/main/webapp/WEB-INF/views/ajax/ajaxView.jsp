...
<script type="text/javascript">
	$(function(){
		...
		$('#bt3').click(function(){
			...
			$.ajax({
				type:'post',//요청 방식은 post로 보내야한다
				url:'ajaxRestJson',
				contentType:'application/json',//contextType을 json유형으로 지정하자
				data:JSON.stringify(jsonData),//json객체는 문자열로 직렬화해서 보내자
				dataType:'json',
				cache:false,
				success:function(res){
					//alert(JSON.stringify(res));
...
<div class="container mt-3" style="height:600px;overflow:auto;">
	...
	<button id="bt3" class="btn btn-outline-primary">ajaxRest(JSON파라미터 전달==>VO로 받기)</button>
	<hr>
