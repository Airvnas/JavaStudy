	...
	<form name="frm" action="memo" method="post">
		<table class="table">
			...
			<tr>
				...
				<td width="80%">
					<input type="text" name="name" placeholder="Name" style="" required class="form-control">
				</td>
			</tr>
			<tr>
				<td width="20%"><b>메모 내용</b></td>
				<td width="80%">
					<input type="text" name="msg" placeholder="Message" style="" required class="form-control">
				</td>
			</tr>
			<tr>
