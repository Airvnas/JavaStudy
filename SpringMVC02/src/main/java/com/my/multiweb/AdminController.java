...
public class AdminController {
	...
	public String productResister(	Model m,
		...
		//C:\myjava\SpringWorkspace\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\SpringMVC02\resources\product_images
		...
		if(pimage!=null) {
			...
			log.info("업로드 이후product=="+product);
		}
