...
public class SummaryController {
	...
	throws Exception
	{
		//로직처리는 서비스 계층에서 처리하는것이 좋다.////////////////////////////////////////////
		log.info("title=="+title+", content==="+content);
		String clientId="1ybfirxmss";
		String clientSecret="6SU5MTYd7c73axaVRoMdwiFwUKdIcVV70UrukMtc";
		...
		//네이버 클라우드 서버로 요청파라미터 데이터를 전송하기 위한 스트림 생성
